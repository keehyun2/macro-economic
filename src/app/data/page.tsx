      ...
      <section>
        ...
        <Card>
          <ul className="list-disc space-y-1.5 pl-4 text-xs leading-relaxed text-muted">
            ...
            <li><b className="text-soft">빚투 손익분기 수익률</b>: 은행 신규 신용대출 평균 금리로 근사했다. 증권사 마진론·카드론은 더 비싸다. &lsquo;본전&rsquo;이 아니라 연간 차입이자에 해당하는 단순 비교선이며 세금·거래비용·변동성·상환 방식은 반영하지 않는다. KOSPI 수익률은 배당이 빠진 가격수익률이다.</li>
            <li><b className="text-soft">실질 스프레드(세전)</b>: 정기예금(1년) 신규금리 − CPI 전년비의 단순 비교. 기대물가·세금·복리를 반영한 실제 실질수익률은 아니며, 일반과세 원천징수(15.4%)를 빼면 그만큼 낮아진다(세후 근사는 예금족 시뮬레이터에서). 적금·보통예금 금리는 통상 더 낮다.</li>
            <li><b className="text-soft">KOSPI·미국 주가지수</b>: ECOS 수록값은 2015=100 재지수화 월평균이라 공식 지수 포인트(예: 코스피 3,000)와 숫자가 다르다. 변화율·수익률 계산에는 영향이 없다.</li>
