...
- **대시보드** — 핵심 지표 8종 + 이번 달 승자·패자(7개 가계 페르소나 점수) + 거시 배경
...
- **데이터** — 사용 통계표 28종(통계표/항목코드 포함)과 데이터 시점, 이용 안내
...
회사채)·환율·가계신용·M2·경기종합지수·국제수지·은행 수신잔액·경제심리지수, 그리고 ECOS에
